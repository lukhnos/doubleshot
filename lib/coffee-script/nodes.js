...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Spawn, Splat, Submodule, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, nulllog, some, starts, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Spawn = Spawn = (function(_super) {

    __extends(Spawn, _super);

    function Spawn(submoduleExpression) {
      this.submoduleExpression = submoduleExpression;
    }

    Spawn.prototype.isAssignable = YES;

    Spawn.prototype.makeReturn = function(res) {
      return this;
    };

    Spawn.prototype.compileNode = function(o) {
      if (!o.worker && !o.nodeprocess) {
